      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center md:items-start text-center md:text-left gap-4">
        ...
        <div className="flex gap-4 mt-4">
          <button 
            ...
            className="px-6 py-2 shadow-[inset_0_0_0_2px_#616467] text-black rounded-full tracking-widest uppercase font-bold bg-transparent hover:bg-[#111212] hover:text-blue-600 dark:text-neutral-200 transition duration-200"
          >
            Contact Info
          </button>
          ...
          >
            <button className="px-6 py-2 shadow-[inset_0_0_0_2px_#616467] text-black rounded-full tracking-widest uppercase font-bold bg-transparent hover:bg-[#616467] hover:text-blue-600 dark:text-neutral-200 transition duration-200">
              Download CV
            </button>
          </a>
        </div>
